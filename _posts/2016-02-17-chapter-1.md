...
![Gazebo](assets/turtlebot_gazebo-turtlebot_world.png)
...
### Publish/Subscribeとノードとトピックで、ロボットに適した通信を実現する
...
![TurtleSim](assets/execute_turtlesim_directly.png)
...
![TurtleSim](assets/execute_turtlesim_via_roslaunch.png)
...
![Browse Software](assets/browse_software.png)

検索結果の中から、アプリケーションっぽい感じがする`turtlebot_apps`をクリック。

![Browse Software result](assets/browse_software_result.png)
...
![TurtleBot Apps](assets/turtlebot_apps.png)
...
![TurtleBot Apps](assets/turtlebot_apps_github.png)
![follower.cpp](assets/follower.png)
...
![Coordinate System](assets/coordinate-system.png)
